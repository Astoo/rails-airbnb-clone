...
# seeds 150 friends with an avatar a description, a price , a name, a picture and a user id,adding an activity tag;
  ...
  Friend.create!(avatar_url:"https://pbs.twimg.com/profile_images/752896539597692928/0M4H1hOZ.jpg",description:"#{Faker::HowIMetYourMother.quote}",price:"#{rand(1..10000)}",name:"#{Faker::Name.name}",pictures:"", user_id: user, activity_id: activity, address:"40 avenue du marechal foch", latitude: 3.028478 , longitude: 50.648678 , zip_code:"59130", country: "France", city:"LAMBERSART")
  Friend.create!(avatar_url:"https://cdn2.opnminded.com/wp-content/uploads/2017/04/beauf03.jpg",description:"#{Faker::HowIMetYourMother.quote}",price:"#{rand(1..10000)}",name:"#{Faker::Name.name}",pictures:"", user_id: user, activity_id: activity, address:"49 avenue du president kennedy", latitude: 3.011484 , longitude: 50.651399 , zip_code:"59130", country: "France", city:"LAMBERSART")
  Friend.create!(avatar_url:"https://images.vice.com/vice/images/articles/meta/2016/05/20/pour-une-rehabilitation-du-jeune-beauf-francais-1463758522.jpg",description:"#{Faker::HowIMetYourMother.quote}",price:"#{rand(1..10000)}",name:"#{Faker::Name.name}",pictures:"", user_id: user, activity_id: activity, address:"157 rue jules guesde", latitude: 3.008136 , longitude: 50.638772 , zip_code:"59160", country: "France", city:"LILLE")
  Friend.create!(avatar_url:"http://img.over-blog-kiwi.com/1/51/43/16/20150612/ob_fa9e99_daech-jeune-homme-beau-intelligent-vie.jpg",description:"#{Faker::HowIMetYourMother.quote}",price:"#{rand(1..10000)}",name:"#{Faker::Name.name}",pictures:"", user_id: user, activity_id: activity, address:"51 avenue de boufflers", latitude: 3.020496 , longitude: 50.643834 , zip_code:"59130", country: "France", city:"LAMBERSART")
